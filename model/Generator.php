...
namespace mayunxuan\kartikgii\model;
...
class Generator extends \yii\gii\Generator
{
    ...
    {
        return 'Kartikgii Model Generator';
    }
    ...
    public function generateRules($table)
    {
        ...
        foreach ($images as $length => $columns) {
            $rules[] = "[['" . implode("', '", $columns) . "'], 'file','extensions' => ['png', 'jpg', 'gif'], 'maxSize' => 1024*1024*1024]";
            $rules[] = "[['" . implode("', '", $columns) . "'], 'string', 'max' => $length]";
        }
